/**
 * LifeCook Background Messaging SW
...
messaging.onBackgroundMessage((payload) => {
    const notificationTitle = payload.notification.title || "LifeCook Pro Update";
    const notificationOptions = {
        body: payload.notification.body || "A dish is ready in the kitchen!",
